...
let inimigos = [];
let pontos = 0;
let vidas = 12; // Nova melhoria: número de vidas
let maxBalas = 8; // Limita o número de balas simultâneas
let imgFundo;
...
function preload() {
  ...
  imagemFundo = loadImage('fundo.jpeg')
}
